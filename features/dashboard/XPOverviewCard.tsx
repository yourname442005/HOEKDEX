...
export function XPOverviewCard({ onOpenAddPerson }: XPOverviewCardProps) {
  ...
  return (
    <div className="relative p-6 sm:p-8 rounded-3xl bg-[#FFFDF9] border-2 border-rose-400/30 shadow-lg shadow-rose-500/5 overflow-hidden transition-all">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 mb-6 relative z-10">
        <div className="flex items-center gap-2.5">
          <div className="w-9 h-9 rounded-2xl bg-rose-500/15 border border-rose-500/30 flex items-center justify-center text-rose-600 shadow-inner">
            <Sparkles className="w-5 h-5" />
          </div>
          <div>
            <span className="text-caption text-rose-600 block">
              Relationship Mastery
            </span>
            <h2 className="text-h3 text-[#1C1917] leading-none">
              Game Progression
            </h2>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-center mb-6 relative z-10">
        ...
        <div className="md:col-span-6 space-y-1">
          <div className="flex items-baseline gap-2">
            <span className="text-4xl sm:text-5xl font-black text-[#1C1917] tracking-tight">
              {totalXp.toLocaleString()}
            </span>
            <span className="text-base font-extrabold text-rose-600 uppercase tracking-wide">
              XP
            </span>
          </div>
        ...
        <div className="md:col-span-6 flex flex-wrap items-center md:justify-end gap-3">
          <div className="flex items-center gap-2 p-2 px-3 rounded-2xl bg-[#F5EFE6] border border-[#E7E0D8]">
          ...
          {nextTier && (
            <div className="flex items-center gap-2 p-2 px-3 rounded-2xl bg-rose-500/10 border border-rose-500/25">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pt-6 mt-6 border-t border-[#E7E0D8] text-xs relative z-10">
