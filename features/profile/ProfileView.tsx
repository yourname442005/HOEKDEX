    ...
    <div className="space-y-6 pb-24 lg:pb-12 max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          ...
          <div className="p-6 rounded-3xl bg-[#FFFDF9] border-2 border-rose-400/40 shadow-lg relative overflow-hidden text-center space-y-4">
            ...
            {/* Avatar */}
            <div className="relative w-24 h-24 mx-auto rounded-full overflow-hidden border-2 border-rose-400 shadow-md bg-[#F5EFE6]">
            ...
            <div>
              ...
              <p className="text-xs text-stone-500 mt-0.5">@{user.username || 'mukesh_k'} · Rank #{user.currentRank} on Leaderboard</p>
            </div>

            {/* Stats */}
            <div className="flex items-center justify-center gap-3 pt-1">
              <div className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-rose-500/10 border border-rose-500/25 text-rose-600 text-xs font-black">
                <Sparkles className="w-3.5 h-3.5 text-rose-500" />
                <span>{user.totalXp} XP</span>
              </div>

              {selectedBadge && (
                <div className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-amber-500/15 border border-amber-500/30 text-amber-700 text-xs font-bold">
            ...
            <div className="pt-4 border-t border-[#E7E0D8] text-[11px] text-stone-500 flex items-center justify-center gap-1.5">
          ...
          <div className="p-4 rounded-2xl bg-[#FFFDF9] border border-[#E7E0D8] space-y-3 shadow-xs">
            <div className="flex items-center justify-between">
              <span className="text-xs font-black uppercase tracking-wider text-rose-600">
                Share My Hoekdex
              </span>
              <span className="text-[11px] text-stone-500">Public profile & invites</span>
            </div>
            ...
            <div className="grid grid-cols-2 gap-2">
              <button
                ...
                className="flex items-center justify-center gap-2 py-2.5 px-3 rounded-xl bg-[#F5EFE6] hover:bg-stone-200 text-stone-800 text-xs font-bold border border-[#E7E0D8] transition-all cursor-pointer"
              >
          ...
          <Link
            ...
            className="p-4 rounded-2xl bg-[#FFFDF9] border border-[#E7E0D8] hover:border-rose-400 flex items-center justify-between transition-colors group shadow-xs block"
          >
            <div className="space-y-0.5">
              <p className="text-xs font-bold text-[#1C1917] group-hover:text-rose-600 transition-colors">
        ...
        <div className="p-6 rounded-3xl bg-[#FFFDF9] border border-[#E7E0D8] space-y-5 shadow-xs">
          <h3 className="text-base font-black text-[#1C1917]">Edit Profile Details</h3>
          ...
          <form onSubmit={handleSave} className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                maxLength={50}
                className="w-full px-3.5 py-2.5 bg-[#F5EFE6] border border-[#E7E0D8] rounded-xl text-[#1C1917] text-sm focus:border-rose-500 focus:outline-none"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full px-3.5 py-2 bg-[#F5EFE6] border border-[#E7E0D8] rounded-xl text-[#1C1917] text-xs focus:border-rose-500"
              />
              <div className="flex items-center gap-2 pt-1">
                ...
                {presetAvatars.map((preset, idx) => (
                  <button
                    ...
                    className="w-8 h-8 rounded-full overflow-hidden border-2 border-stone-300 hover:border-rose-500 transition-colors"
                  >
                    {/* eslint-disable-next-line @next/next/no-img-element */}
            ...
            <div className="pt-4 border-t border-[#E7E0D8]">
              <button
                ...
                className="w-full flex items-center justify-center gap-2 py-3 rounded-full bg-rose-600 hover:bg-rose-500 active:scale-95 text-white font-black text-sm shadow-lg shadow-rose-600/20 transition-all cursor-pointer"
              >
