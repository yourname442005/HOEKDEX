...
export function OnboardingView() {
  ...
  return (
    <div className="min-h-screen bg-[#FAF5EF] flex items-center justify-center p-4">
      <div className="w-full max-w-lg bg-[#FFFDF9] border border-[#E7E0D8] rounded-3xl p-6 sm:p-8 shadow-xl space-y-6 relative overflow-hidden">
        {/* Ambient glow */}
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between text-xs font-bold text-stone-500">
            <span className="text-rose-600 uppercase tracking-widest">Step {step} of 5</span>
          ...
          <div className="space-y-5 animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-[#F5EFE6] border border-[#E7E0D8] focus:border-rose-500 rounded-2xl text-[#1C1917] font-semibold text-sm focus:outline-none"
              />
            </div>
            ...
            <div className="pt-4">
              <button
                ...
                onClick={() => setStep(2)}
                className="w-full flex items-center justify-center gap-2 py-3 rounded-full bg-rose-600 hover:bg-rose-500 active:scale-95 disabled:opacity-50 text-white font-extrabold text-sm shadow-lg shadow-rose-600/20 transition-all cursor-pointer"
              >
                <span>Continue</span>
        ...
        {step === 2 && (
          <div className="space-y-5 animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="flex flex-col items-center justify-center py-2">
              <div className="w-20 h-20 rounded-full overflow-hidden border-2 border-rose-400 shadow-md bg-[#F5EFE6]">
            ...
            {/* Preset selector */}
            <div className="space-y-2">
              <span className="block text-xs font-bold uppercase tracking-wider text-stone-700 text-center">
                Choose a Preset
              </span>
                ...
                {presetAvatars.map((preset, idx) => (
                  <button
                    ...
                    className={cn(
                      ...
                      avatarUrl === preset
                        ? 'border-rose-500 ring-2 ring-rose-500 scale-110 shadow-md'
            ...
            <div className="flex items-center gap-3 pt-4">
              <button
                type="button"
                onClick={() => setStep(1)}
                className="px-5 py-3 rounded-full bg-[#F5EFE6] border border-[#E7E0D8] text-stone-700 hover:text-stone-900 text-sm font-bold transition-colors cursor-pointer"
              >
                Back
              </button>
              <button
                type="button"
                onClick={() => setStep(3)}
                className="flex-1 flex items-center justify-center gap-2 py-3 rounded-full bg-rose-600 hover:bg-rose-500 active:scale-95 text-white font-extrabold text-sm shadow-lg shadow-rose-600/20 transition-all cursor-pointer"
              >
                <span>Continue</span>
                <ArrowRight className="w-4 h-4" />
              </button>
        ...
        {step === 3 && (
          <div className="space-y-5 animate-in fade-in zoom-in-95 duration-200">
            ...
            {/* Toggle 1 */}
            <div className="p-4 rounded-2xl bg-[#F5EFE6] border border-[#E7E0D8] flex items-center justify-between gap-3">
              <div className="space-y-0.5">
                <p className="text-sm font-bold text-[#1C1917]">Join Friend Leaderboards</p>
            ...
            <div className="p-4 rounded-2xl bg-[#F5EFE6] border border-[#E7E0D8] flex items-center justify-between gap-3">
              <div className="space-y-0.5">
                <p className="text-sm font-bold text-[#1C1917]">Share XP on Public Profile</p>
                <p className="text-xs text-stone-500">
        ...
        {step === 4 && (
          <div className="space-y-5 animate-in fade-in zoom-in-95 duration-200">
            <div className="space-y-1 text-center">
              <div className="w-14 h-14 mx-auto rounded-2xl bg-pink-500/15 border border-pink-500/30 text-pink-600 flex items-center justify-center shadow-lg shadow-pink-500/10">
            ...
            <div className="p-4 rounded-2xl bg-[#F5EFE6] border border-[#E7E0D8] space-y-2 text-xs text-stone-700">
              <p className="font-bold text-[#1C1917]">Optional Social Boost</p>
            ...
            <div className="pt-2 border-t border-[#E7E0D8] flex items-center justify-between">
              <button
                type="button"
                onClick={() => setStep(3)}
                className="px-4 py-2 rounded-full text-stone-500 hover:text-stone-900 text-xs font-bold transition-colors cursor-pointer"
              >
                Back
              </button>
              <button
        ...
        {step === 5 && (
          <div className="space-y-5 text-center animate-in fade-in zoom-in-95 duration-200">
            <div className="w-16 h-16 mx-auto rounded-3xl bg-rose-500/15 border border-rose-500/30 text-rose-600 flex items-center justify-center shadow-lg shadow-rose-600/20">
            ...
            {/* Feature Checklist */}
            <div className="text-left space-y-2 p-4 rounded-2xl bg-[#F5EFE6] border border-[#E7E0D8] text-xs text-stone-700">
              <div className="flex items-center gap-2">
            ...
            <div className="pt-2">
              <button
                ...
                className="w-full py-3.5 px-6 text-sm font-black text-white bg-rose-600 hover:bg-rose-500 active:scale-95 rounded-full shadow-lg shadow-rose-600/20 transition-all cursor-pointer"
              >
